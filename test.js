  ...
  const products=[
    ...
    },
    {
      ...
      "rating": 4.26,
      "stock": 65,
      "city": "Impression of Acqua Di Gio",
      "category": "fragrances",
    ...
    },
    {
      ...
      "description": "Fine quality cityed Product Keep in a cool and dry place",
      "price": 20,
    ...
    },
    {
      ...
      "description": "Many store is creating new designs and trend every month and every year. Daraz.pk have a beautiful range of men fashion cities",
      "price": 23,
      "discountPercentage": 12.76,
      "rating": 4.26,
      "stock": 132,
      "city": "Vintage Apparel",
    ...
    },
    {
      ...
      "description": "city: vintage Apparel ,Export quality",
      "price": 35,
    ...
    },
    {
      ...
      "description": "Gender: Men , Colors: Same as DisplayedCondition: 100% city New",
      "price": 40,
    ...
    {
      "id": 62,
      "title": "Waterproof Leather city Watch",
    ...
    },
    {
      "id": 77,
      "title": "Rose Ring",
      "description": "city: The Greetings Flower Colour: RedRing Colour: GoldenSize: Adjustable",
      "price": 100,
    ...
    },
    {
      ...
      "description": "Orignal Metal Kabir Singh design 2020 Sunglasses Men city Designer Sun Glasses Kabir Singh Square Sunglass",
      "price": 50,
      "discountPercentage": 15.6,
      "rating": 4.62,
      "stock": 78,
    ...
    },
    {
      ...
      "rating": 4.04,
      "stock": 115,
      "city": "METRO 70cc Motorcycle - MR70",
      "category": "motorcycle",
    ...
    const mappedArray1 = [...a].map(c => ({ value: c, label: c, checked: false }));
    // console.log(mappedArray1);

    const b = new Set([...products.map(p => p.city)]);
    const mappedArray2 = [...b].map(c => ({ value: c, label: c, checked: false }));
